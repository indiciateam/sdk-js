...
/** @internal */
export const PostV1SearchInfrastructureShodanRequest$outboundSchema:
  z.ZodMiniType<
    PostV1SearchInfrastructureShodanRequest$Outbound,
    PostV1SearchInfrastructureShodanRequest
  > = z.object({
    query: z.string(),
  });

export function postV1SearchInfrastructureShodanRequestToJSON(
  postV1SearchInfrastructureShodanRequest:
    PostV1SearchInfrastructureShodanRequest,
): string {
  return JSON.stringify(
    PostV1SearchInfrastructureShodanRequest$outboundSchema.parse(
      postV1SearchInfrastructureShodanRequest,
    ),
  );
}
...
/** @internal */
export const PostV1SearchInfrastructureShodanLocation$inboundSchema:
  z.ZodMiniType<PostV1SearchInfrastructureShodanLocation, unknown> = z.pipe(
    z.object({
      city: types.string(),
...
export function postV1SearchInfrastructureShodanLocationFromJSON(
  jsonString: string,
): SafeParseResult<
  PostV1SearchInfrastructureShodanLocation,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      PostV1SearchInfrastructureShodanLocation$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'PostV1SearchInfrastructureShodanLocation' from JSON`,
  );
}
...
export const Match$inboundSchema: z.ZodMiniType<Match, unknown> = z.pipe(
  z.object({
    ...
    isp: types.string(),
    location: z.lazy(() =>
      PostV1SearchInfrastructureShodanLocation$inboundSchema
    ),
    org: types.string(),
    os: types.string(),
    port: types.number(),
...
/** @internal */
export const PostV1SearchInfrastructureShodanData$inboundSchema: z.ZodMiniType<
  PostV1SearchInfrastructureShodanData,
  unknown
> = z.object({
...
export function postV1SearchInfrastructureShodanDataFromJSON(
  jsonString: string,
): SafeParseResult<PostV1SearchInfrastructureShodanData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      PostV1SearchInfrastructureShodanData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PostV1SearchInfrastructureShodanData' from JSON`,
  );
}

/** @internal */
export const PostV1SearchInfrastructureShodanResponse$inboundSchema:
  z.ZodMiniType<PostV1SearchInfrastructureShodanResponse, unknown> = z.object({
    data: z.lazy(() => PostV1SearchInfrastructureShodanData$inboundSchema),
    success: types.boolean(),
    error: types.optional(types.string()),
  });

export function postV1SearchInfrastructureShodanResponseFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      PostV1SearchInfrastructureShodanResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'PostV1SearchInfrastructureShodanResponse' from JSON`,
  );
}
