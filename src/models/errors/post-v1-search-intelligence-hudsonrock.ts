 ...
 * Internal Server Error
 */
export class PostV1SearchIntelligenceHudsonrockInternalServerError
  extends IndiciaError
{
  ...
  constructor(
    err: PostV1SearchIntelligenceHudsonrockInternalServerErrorData,
...
/** @internal */
export const PostV1SearchIntelligenceHudsonrockInternalServerError$inboundSchema:
  z.ZodMiniType<
    PostV1SearchIntelligenceHudsonrockInternalServerError,
    unknown
  > = z.pipe(
    z.object({
