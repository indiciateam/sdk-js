...
export function intelligenceGeolocateMedia(
  ...
  Result<
    EventStream<operations.GeolocationEvent>,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GeolocateMediaRequest$outboundSchema, value),
        ...
        z.transform(stream => {
          return new EventStream(stream, rawEvent => {
            return {
              ...
              value: operations.GeolocationEvent$inboundSchema.parse(rawEvent),
            };
          });
        }),
      ),
