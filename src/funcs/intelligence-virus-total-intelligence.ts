...
export function intelligenceVirusTotalIntelligence(
  ...
  Result<
    operations.VirusTotalIntelligenceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.VirusTotalIntelligenceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/search/intelligence/virustotal")();
  ...
  const context = {
    ...
    operationID: "virusTotalIntelligence",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VirusTotalIntelligenceResponse$inboundSchema),
