 ...
 */
export function toolsSearchAppStore(
  client: IndiciaCore,
  request: operations.SearchAppStoreRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SearchAppStoreResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SearchAppStoreRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/tools/appstore")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SearchAppStoreResponse$inboundSchema),
