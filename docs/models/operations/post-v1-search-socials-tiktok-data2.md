...
```typescript
import { PostV1SearchSocialsTiktokData2 } from "@indiciaosint/sdk/models/operations";

let value: PostV1SearchSocialsTiktokData2 = {
    ...
    byShares: [
      {
        createdDate: "<value>",
        description:
          "blight ultimately agreeable um inasmuch honestly indeed knowledgeably",
        engagementRate: "<value>",
        value: 6129.7,
        videoId: "<id>",
        videoUrl: "https://repentant-packaging.info/",
      },
    ],
    byViews: [],
  },
...
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `audienceAndTimingInsights`                                                                         | [operations.AudienceAndTimingInsights](../../models/operations/audience-and-timing-insights.md)     | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `contentStrategyDeepDive`                                                                           | [operations.ContentStrategyDeepDive](../../models/operations/content-strategy-deep-dive.md)         | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `keyMetrics`                                                                                        | [operations.KeyMetrics](../../models/operations/key-metrics.md)                                     | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `profileSummary`                                                                                    | [operations.ProfileSummary](../../models/operations/profile-summary.md)                             | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `reportGeneratedUtc`                                                                                | *string*                                                                                            | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `shadowBanRiskAssessment`                                                                           | [operations.ShadowBanRiskAssessment](../../models/operations/shadow-ban-risk-assessment.md)         | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `topPerformingVideosSnapshot`                                                                       | [operations.TopPerformingVideosSnapshot](../../models/operations/top-performing-videos-snapshot.md) | :heavy_check_mark:                                                                                  | N/A                                                                                                 |
| `viralPotentialAnalysis`                                                                            | [operations.ViralPotentialAnalysis](../../models/operations/viral-potential-analysis.md)            | :heavy_check_mark:                                                                                  | N/A                                                                                                 |