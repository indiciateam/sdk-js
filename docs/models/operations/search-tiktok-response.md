...
```typescript
import { SearchTiktokResponse } from "@indiciaosint/sdk/models/operations";

let value: SearchTiktokResponse = {
  data: {
    data: [
      {
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `data`                                                                         | [operations.SearchTiktokData3](../../models/operations/search-tiktok-data3.md) | :heavy_check_mark:                                                             | N/A                                                                            |
