...
```typescript
import { SearchTiktokData2 } from "@indiciaosint/sdk/models/operations";

let value: SearchTiktokData2 = {
    ...
    byShares: [
      {
        createdDate: "<value>",
        description:
          "garage outsource square ew redound ferociously kindheartedly",
        engagementRate: "<value>",
        value: 9777.82,
        videoId: "<id>",
        videoUrl: "https://stunning-pear.org/",
      },
    ],
    byViews: [
      {
